...
\usepackage[style=apa, backend=biber]{biblatex} % Use APA citation style with biber
\addbibresource{chap1/introduction_biblio.bib}  % Add all the .bib files you need
\addbibresource{chap2/lit_overview_biblio.bib}
\addbibresource{references.bib}             
\usepackage[numbers]{natbib}
\bibliographystyle{plainnat} % or another style like 'IEEEtran' or 'apalike'
...
\title{Optimizing Document Search\\Accuracy and Interaction:\\
       ...
       and\\LLM-Powered Chat Interfaces
                                                    ...
                                                    % words in lower case)
% \tagline{some hyped-up tagline or pwede nga wala}   % tag line
\author{Carlo P. Arellano\\
        Michael James M. Carnaje\\
        Fulgent Kvasir E. Lavesores}                              % your names
%\authorID{123456M}                                  % your University Identifier (not used)
\supervisor{Prof. Dante D. Dinawanao}                 % your supervisor(s) name - no . in Dr
...
\graphicspath{{./images/}{./chap1/images/}{./chap2/images/}{./chap3/images/}{./chap4/images/}}   % Paths where to look for images, if defined "images" must always be there as it holds the images in-use by the template.
...
\begin{document}
\frontmatter 
    \input{frontmatter/revision}       % revision table
    \maketitle
...
{\backmatter
    ...
    \printbibliography % Automatically includes all referenced citations
    \printindex
}
\end{document}
